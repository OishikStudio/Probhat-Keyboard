...
import probhat.keyboard.latin.common.UnicodeSurrogate;
import probhat.keyboard.latin.inputlogic.PrivateCommandPerformer;
import probhat.keyboard.latin.settings.SpacingAndPunctuations;
import probhat.keyboard.latin.utils.CapsModeUtils;
import probhat.keyboard.latin.utils.DebugLogUtils;
import probhat.keyboard.latin.utils.NgramContextUtils;
import probhat.keyboard.latin.utils.ScriptUtils;
import probhat.keyboard.latin.utils.SpannableStringUtils;
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See probhat.keyboard.latin.common.Constants.UnicodeSurrogate
