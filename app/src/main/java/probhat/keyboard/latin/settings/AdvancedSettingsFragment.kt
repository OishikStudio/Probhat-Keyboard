 ...
 */
package probhat.keyboard.latin.settings
...
import probhat.keyboard.latin.utils.ChecksumCalculator
import probhat.keyboard.keyboard.KeyboardLayoutSet
import probhat.keyboard.keyboard.KeyboardSwitcher
import probhat.keyboard.keyboard.internal.keyboard_parser.LAYOUT_NUMBER
import probhat.keyboard.keyboard.internal.keyboard_parser.LAYOUT_NUMPAD
import probhat.keyboard.keyboard.internal.keyboard_parser.LAYOUT_NUMPAD_LANDSCAPE
import probhat.keyboard.keyboard.internal.keyboard_parser.LAYOUT_PHONE
import probhat.keyboard.keyboard.internal.keyboard_parser.LAYOUT_PHONE_SYMBOLS
import probhat.keyboard.keyboard.internal.keyboard_parser.LAYOUT_SYMBOLS
import probhat.keyboard.keyboard.internal.keyboard_parser.LAYOUT_SYMBOLS_SHIFTED
import probhat.keyboard.latin.AudioAndHapticFeedbackManager
import probhat.keyboard.latin.BuildConfig
import probhat.keyboard.latin.R
import probhat.keyboard.latin.SystemBroadcastReceiver
import probhat.keyboard.latin.checkVersionUpgrade
import probhat.keyboard.latin.common.FileUtils
import probhat.keyboard.latin.common.LocaleUtils.constructLocale
import probhat.keyboard.latin.settings.SeekBarDialogPreference.ValueProxy
import probhat.keyboard.latin.utils.AdditionalSubtypeUtils
import probhat.keyboard.latin.utils.CUSTOM_LAYOUT_PREFIX
import probhat.keyboard.latin.utils.DeviceProtectedUtils
import probhat.keyboard.latin.utils.ExecutorUtils
import probhat.keyboard.latin.utils.JniUtils
import probhat.keyboard.latin.utils.editCustomLayout
import probhat.keyboard.latin.utils.getStringResourceOrName
import probhat.keyboard.latin.utils.infoDialog
import probhat.keyboard.latin.utils.reloadEnabledSubtypes
import probhat.keyboard.latin.utils.updateAdditionalSubtypes
import java.io.File
    ...
    private fun upgradeFileNames(originalName: String): String {
        return when {
            ...
            originalName.startsWith("layouts") -> {
                ...
                if (localeString in listOf(LAYOUT_SYMBOLS, LAYOUT_SYMBOLS_SHIFTED, LAYOUT_NUMBER, LAYOUT_NUMPAD, LAYOUT_NUMPAD_LANDSCAPE, LAYOUT_PHONE, LAYOUT_PHONE_SYMBOLS))
