...
package probhat.keyboard.latin.inputlogic;
...
import probhat.keyboard.latin.Dictionary;
import probhat.keyboard.latin.DictionaryFacilitator;
import probhat.keyboard.latin.LastComposedWord;
import probhat.keyboard.latin.LatinIME;
import probhat.keyboard.latin.NgramContext;
import probhat.keyboard.latin.RichInputConnection;
import probhat.keyboard.latin.Suggest;
import probhat.keyboard.latin.Suggest.OnGetSuggestedWordsCallback;
import probhat.keyboard.latin.SuggestedWords;
import probhat.keyboard.latin.SuggestedWords.SuggestedWordInfo;
import probhat.keyboard.latin.WordComposer;
...
import probhat.keyboard.latin.common.StringUtilsKt;
import probhat.keyboard.latin.common.SuggestionSpanUtilsKt;
...
import probhat.keyboard.latin.utils.AsyncResultHolder;
import probhat.keyboard.latin.utils.InputTypeUtils;
import probhat.keyboard.latin.utils.Log;
import probhat.keyboard.latin.utils.RecapitalizeStatus;
import probhat.keyboard.latin.utils.ScriptUtils;
import probhat.keyboard.latin.utils.StatsUtils;
import probhat.keyboard.latin.utils.TextRange;
...
public final class InputLogic {
     ...
     *     {@link probhat.keyboard.keyboard.KeyboardSwitcher#getKeyboardShiftMode()}
     * @return the complete transaction object
     */
    ...
    /**
     * Make a {@link probhat.keyboard.latin.SuggestedWords} object containing a typed word
     * and obsolete suggestions.
     * See {@link probhat.keyboard.latin.SuggestedWords#getTypedWordAndPreviousSuggestions(
     *      SuggestedWordInfo, probhat.keyboard.latin.SuggestedWords)}.
